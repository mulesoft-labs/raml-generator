 ...
 * @return {String}
 */
function toPropertyFormat (uri, spec) {
 ...
 * @param {Object} spec
 */
function attachResource (obj, resource, spec, security) {
  ...
  function recurse (obj, parts) {
    ...
    if (part !== '/') {
      ...
      if (!key || obj.children.hasOwnProperty(key)) {
        ...
        if (toUriFormat(part, spec) === obj.children[key].relativeUri) {
        ...
        var relativeUri = toUriFormat(part, spec)
        ...
        obj = obj.children[key] = {
          ...
          parent: obj,
          children: {},
          absoluteUri: obj.absoluteUri + relativeUri,
          relativeUri: relativeUri,
          originalRelativeUri: part,
          originalAbsoluteUri: obj.originalAbsoluteUri + part,
          uriParameters: uriParameters,
          absoluteUriParameters: obj.absoluteUriParameters.concat(uriParameters)
        }
      }
    }
    ...
    obj.methods = sanitizeMethods(resource.methods, obj, spec, security)
    ...
    if (resource.resources) {
      resource.resources.forEach(function (resource) {
        attachResource(obj, resource, spec, security)
      })
    }
 ...
 * @return {Object}
 */
module.exports = function (resources, spec, security) {
  ...
  resources.forEach(function (resource) {
    return attachResource(obj, resource, spec, security)
  })
